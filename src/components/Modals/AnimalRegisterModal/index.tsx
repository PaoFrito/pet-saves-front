...
const sizeOptions = [
  { label: Size.sm, icon: undefined },
  { label: Size.md, icon: undefined },
  { label: Size.lg, icon: undefined },
];

const isToFeed = [
  { label: "Criar publicação", icon: undefined },
                  ...
                  >
                    {({ getRootProps, getInputProps }) => (
                      <Box
                        ...
                        borderRadius="5px"
                        border="2px dashed #5072E8"
                        cursor="pointer"
                        _hover={{ backgroundColor: "#00000012" }}
                      >
                        <Grid
                          {...getRootProps({
                            className: "dropzone",
                        ...
                        >
                          <input {...getInputProps()} />
                          {!file?.preview ? (
                            <Text color="#5072E8" fontWeight="500">
                              Arraste uma foto do animal
                            </Text>
                          ) : (
                            <Img src={file?.preview} w="400px" h="200px" />
                          )}
                        </Grid>
                      </Box>
                    )}
